...
challenges = {
  ...
  Loops:{draw:loops, mousePressed:loopsClick},
  Recursion:{draw:recursion, mousePressed:recursionClick, setup:recursionSetup},
  Broadcasts:{draw:broadcasts, mousePressed:broadcastsClick},
  ...
  Extensions:{draw:extensions, mousePressed:extensionsClick},
